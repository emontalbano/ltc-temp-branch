...
var CacheService = /** @class */ (function () {
    ...
    CacheService.prototype.retryFromDatabase = function (restService, key) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _i, key_3, fieldList, pending_1, toCreate, toUpdate, i, item, _c, _d, _e, obj, _f, _g, _h, obj;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 6:
                        ...
                        toCreate = [];
                        toUpdate = [];
                        for (i = 0; i < pending_1.rows.length; i++) {
                            item = pending_1.rows.item(i);
...
var PendingComponent = /** @class */ (function () {
    ...
    PendingComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'jh-nav-pending',template:/*ion-inline-start:"/Users/ed/ltc-temp-branch/src/common/pending/pending.html"*/'<div class="mat-spin-wrapper" *ngIf="(meta | async).pending">\n  <mat-spinner diameter="30"></mat-spinner>\n</div>\n'/*ion-inline-end:"/Users/ed/ltc-temp-branch/src/common/pending/pending.html"*/,
            providers: []
        }),
...
var DateTimePickerComponent = /** @class */ (function () {
    ...
    DateTimePickerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'datetime-picker',template:/*ion-inline-start:"/Users/ed/ltc-temp-branch/src/common/datetime-picker/datetime-picker.html"*/'<mat-label>{{ label }}</mat-label>\n<button mat-button (click)="openPicker()">\n  <mat-icon>date_range</mat-icon> {{ value | date: \'short\' }}\n</button>\n'/*ion-inline-end:"/Users/ed/ltc-temp-branch/src/common/datetime-picker/datetime-picker.html"*/,
            providers: []
        }),
...
var BillingDialog = /** @class */ (function () {
    ...
    BillingDialog = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'jh-settings-billing',template:/*ion-inline-start:"/Users/ed/ltc-temp-branch/src/pages/settings/dialogs/billing.html"*/'<h1 mat-dialog-title>Default Billing Rate</h1>\n<form [formGroup]="form" (ngSubmit)="submit(form)">\n  <mat-dialog-content>    \n    <mat-form-field [floatLabel]="true">\n      <mat-label>Hourly Rate</mat-label>\n      <span class="prefix">$</span>\n      <input matInput formControlName="rate__c" >\n    </mat-form-field>    \n  </mat-dialog-content>\n  <mat-dialog-actions>\n    <button mat-button color="primary" type="submit">SAVE</button>\n    <button mat-button mat-dialog-close>CANCEL</button>\n  </mat-dialog-actions>\n</form>'/*ion-inline-end:"/Users/ed/ltc-temp-branch/src/pages/settings/dialogs/billing.html"*/
        }),
